        ...
        rChannel.send({ embed: rEmbed }).then(msg => {
            msg.react("✅").then(xd => {
                msg.react("❌").then(r => {
                    ...
                    const brFilter = (reaction, user) => reaction.emoji.name === "🚫" && user.id !== "455858358474244106";
                    const checkFilter = (reaction, user) => reaction.emoji.name === "✅" && user.id !== "455858358474244106";
                    const xFilter = (reaction, user) => reaction.emoji.name === "❌" && user.id !== "455858358474244106"; 
